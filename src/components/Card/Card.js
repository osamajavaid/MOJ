...
const Card = (props) => {
  return (
    <>
        <div className="card shadow-lg shadow-slate-900 rounded-sm lg:w-88 hover:scale-[1.02] transition ease-in-out delay-150">
            ...
            <div className="py-4 cardText text-white px-2 bg-gray-800 bg-opacity-80 text-center">
