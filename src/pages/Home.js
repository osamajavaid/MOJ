    ...
    <div className="px-8 pt-20 md:pt-0">
        <div className='flex flex-col-reverse md:flex-row items-center justify-around gap-10 md:gap-0 h-screen w-full'>
            <div className="text-white">
                ...
                <p className='font-[poppins] text-lg lg:text-2xl font-extralight pb-4'>Web Desinger and Web Developer
                <br />from Peshawar, Pakistan. <br />
                    I create custom websites <br/> to
                    help bussiness do better online.</p>
                <button className='w-36 lg:w-44 my-2 px-6 lg:px-8 py-2 text-lg lg:text-xl font-[montserrat] hover:bg-white hover:text-black bg-blue-600'>Hire Me!</button>
            </div>
